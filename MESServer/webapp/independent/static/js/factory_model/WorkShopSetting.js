        ...
        TableMode: [
				...
				'<td data-title="BusinessUnit" data-value="{{BusinessUnit}}" >{{BusinessUnit}}</td>',
                 '<td data-title="IPTModuleID" data-value="{{IPTModuleID}}" >{{IPTModuleID}}</td>',
                   '<td data-title="SCPeriod" data-value="{{SCPeriod}}" >{{SCPeriod}}</td>',
        ...
        events: function () {
            ...
            $("body").delegate("#zace-edit-level", "click", function () {
                ...
                var default_value = {           
                    ...
                    SCPeriod: SelectData[0].SCPeriod,
                ...
                $("body").append($com.modal.show(default_value, KEYWORD_Level, "修改", function (rst) {
                    ...
                    SelectData[0].SCPeriod = Number(rst.SCPeriod);
            ...
            $("body").delegate("#zace-add-level", "click", function () {
                ...
                $("body").append($com.modal.show(DEFAULT_VALUE_Level, KEYWORD_Level, "新增", function (rst) {
                    ...
                    PositionTemp.SCPeriod = Number(rst.SCPeriod);
