require(['../static/utils/js/jquery-3.1.1', '../static/utils/js/base/base'], function ($zace, $com) {
    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-searchAll-level", "click", function () {
                ...
                $("body").append($com.modal.show(default_value, KEYWORD_Level, "查询", function (rst) {
                    ...
                    default_value.BusinessUnitID = Number(rst.BusinessUnitID);
                    /// default_value.Position = Number(rst.Position);
                    $com.table.filterByConndition($("#femi-riskLevelAll-tbody"), DATAAllBasic, default_value, "ID");
            ...
            $("body").delegate("#zace-search-all", "change", function () {
                ...
                if (value == undefined || value == "" || value.trim().length < 1)
                    ...
                    $com.table.filterByLikeString($("#femi-riskLevelAll-tbody"), DataAllBSearch, value, "ID");
        ...
        run: function () {
            //WorkShopID = window.parent.UserParams["LineSetup"].WorkShopID;
            //BusinessUnitID = window.parent.UserParams["LineSetup"].BusinessUnitID;
            //FactoryID = window.parent.UserParams["LineSetup"].FactoryID;
