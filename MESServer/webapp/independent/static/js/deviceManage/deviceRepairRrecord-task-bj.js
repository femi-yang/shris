...
'</tr>',
    ...
    model = $com.Model.create({
        ...
        events: function () {
             ...
             //保养日志(从任务单到申请单)
                 $("body").delegate("#zace-edit-Device-apply","click",function(){
                     var vdata = { 'header': '备件维修申请单', 'href': './device_manage/deviceRepairRrecord-apply-bj.html', 'id': 'deviceRepairRrecord-apply-bj', 'src': './static/images/menu/deviceManage/deviceRepairLog.png' };
        ...
        run: function () {
            ...
            model.com.getSpareModel({ SpareWorkType: 0, SupplierID: 0, ModelPropertyID: 0, Active: -1, SupplierModelNo: "", StartTime: "2019-02-10 15:38:29", EndTime: "2029-05-10 15:38:29" }, function (res4) {
                ...
                model.com.getDeviceRepairType({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res3) {
                    ...
                    model.com.getDeviceRepairItem({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2000-04-26 19:15:19", EndTime: "5029-05-5 10:15:19", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res1) {
                        DateItem = res1.list;
        ...
        com: {
            refresh: function () {
                model.com.getDeviceRepairTask({
                    ...
                    ConfirmID: 0, DSType: 2, Status: 0, StartTime: "2000-04-26 19:15:19", EndTime: "4029-05-5 10:15:19"
                }, function (resTask) {
                    if (!resTask)
                        return;
                ...
                model.com.getDeviceRepairTask({
                    ModelID: -1, LedgerID: 0, TypeID: 0, OAGetType: 3, ApplicantID: 0, ApproverID: 0,
                    ConfirmID: 0, DSType:2, Status: 0, StartTime: "2000-04-26 19:15:19", EndTime: "4029-05-5 10:15:19"
                }, function (resQR) {
                    if (!resQR)
                        return;
                ...
                model.com.getDeviceRepairTask({
                    ModelID: -1, LedgerID: 0, TypeID: 0, OAGetType: 4, ApplicantID: 0, ApproverID: 0,
                    ConfirmID: 0, DSType: 2, Status: 0, StartTime: "2000-04-26 19:15:19", EndTime: "4029-05-5 10:15:19"
                }, function (resBY) {
                    if (!resBY)
                        return;
