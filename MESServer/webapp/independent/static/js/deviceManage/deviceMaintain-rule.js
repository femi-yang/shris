...
//          //设备保养禁用(规则表)           
           ...
           //设备保养导出(规则表)
            ...
            $("body").delegate("#zace-type-search-Regular", "click", function () {
                var vdata = { 'header': '设备保养模板', 'href': './device_manage/deviceMaintain-type.html', 'id': 'DeviceMaintenance-type', 'src': './static/images/menu/deviceMaintain.png' };
        ...
        run: function () {
            ...
            BYTyperule = [];
            model.com.getDeviceMaintainType({ ModelID: -1, Name: "", DSType: 1, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res1) {
        ...
        com: {
            refresh: function () {
//          	 ModelID:{int},Name:{String},TypeID:{int},DSType:{int}, Active:{int}
                model.com.getDeviceMaintainRule({ ModelID: -1, Name: "", TypeID: 0, DSType: 1, Active: -1, BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (resRule) {
                    if (!resRule)
                        return;
