    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-active-Device-Type", "click", function () {
                ...
                for (var j = 0; j < BJWXType.length; j++) {
                    if (BJWXType[j].ModelID == Number(SelectData[0].ModelID)) {
                        if (BJWXType[j].Active == 1) {
        ...
        run: function () {
            ...
            WDataItem = [];
            model.com.getDeviceRepairItem({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-26 19:15:19", EndTime: "2029-05-5 10:15:19", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res1) {
        ...
        com: {
            refresh: function () {
                ...
                model.com.getDeviceRepairType({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (resType) {
                    if (!resType)
                        return;
