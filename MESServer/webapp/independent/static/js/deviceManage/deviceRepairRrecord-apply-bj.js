...
//       "DSType|DSType",
    ...
    model = $com.Model.create({
        ...
        run: function () {
            ...
            model.com.getDeviceRepairType({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res2) {
                DateMType = res2.list;
                ...
                model.com.getSpareLedger({ ModelID: -1, BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 ,DeviceLedgerID:0,ApplyID:0,Status:0}, function (res3) {
                    //var wLedger = [];
                ...
                model.com.getSpareModel({ DeviceWorkType: 0, SupplierID: 0, ModelPropertyID: 0, SystemID: 0, SystemPropertyID: 0, ControllerID: 0, ControllerPropertyID: 0, Active: -1, SupplierModelNo: "", SystemVersion: "", ControllerModel: "", StartTime: "2019-02-10 15:38:29", EndTime: "2029-05-10 15:38:29" }, function (res1) {
            ...
            model.com.getDeviceRepairItem({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-26 19:15:19", EndTime: "2029-05-5 10:15:19", BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1 }, function (res1) {
                DateMItem = res1.list;
                $.each(res1.list, function (i, item) {
        ...
        com: {
            ...
            load: function () {
                model.com.getDeviceRepairType({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1 }, function (res2) {
                    DateMType = res2.list;
                    $.each(res2.list, function (i, item) {
                        TypeSource_Device_Apply.TypeID.push({
                            name: item.Name,
