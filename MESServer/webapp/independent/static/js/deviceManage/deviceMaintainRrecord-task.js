    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-edit-Device-apply","click",function(){
                var vdata = { 'header': '设备保养申请单', 'href': './device_manage/deviceMaintainRrecord-apply.html', 'id': 'DeviceMaintainRrecord-apply', 'src': './static/images/menu/deviceManage/deviceMaintainLog.png' };
            ...
            $("body").delegate("#zace-Device-Rrecord","click",function(){
                var vdata = { 'header': '备件保养日志', 'href': './device_manage/deviceMaintainRrecord-bj.html', 'id': 'DeviceMaintainRrecord-bj', 'src': './static/images/menu/deviceMaintain.png'};
                window.parent.iframeHeaderSet(vdata); 
            })
        ...
        run: function () {
            ...
            var wDevice = window.parent._Device;
                        ...
                        model.com.getDeviceModel({ DeviceWorkType: 0, SupplierID: 0, ModelPropertyID: 0, SystemID: 0, SystemPropertyID: 0, ControllerID: 0, ControllerPropertyID: 0, Active: -1, SupplierModelNo: "", SystemVersion: "", ControllerModel: "", StartTime: "2019-02-10 15:38:29", EndTime: "2029-05-10 15:38:29" }, function (res4) {
                            ...
                            model.com.getDeviceMaintainType({ ModelID: -1, Name: "", DSType: 1, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res3) {
                                ...
                                model.com.getDeviceMaintainItem({ ModelID: -1, Name: "", DSType: 1, Active: -1, StartTime: "2000-04-26 19:15:19", EndTime: "5029-05-5 10:15:19", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res1) {
                                    DateItem = res1.list;
        ...
        com: {
            refresh: function () {
                model.com.getDeviceMaintainTask({
                    ModelID: -1, LedgerID: 0, TypeID: 0, OAGetType: 0, ApplicantID: 0, ApproverID: 0, ConfirmID: 0, DSType: 1,
                    Status: 0, StartTime: "2000-04-26 19:15:19", EndTime: "4029-05-5 10:15:19", BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1, HasName:1
                }, function (resTask) {
                    if (!resTask)
                        return;
                ...
                model.com.getDeviceMaintainTask({
                    ModelID: -1, LedgerID: 0, TypeID: 0, OAGetType: 0, ApplicantID: 0, ApproverID: 0, ConfirmID: 0, DSType: 1,
                    Status: 0, StartTime: "2000-04-26 19:15:19", EndTime: "4029-05-5 10:15:19", BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1
                }, function (resQR) {
                    if (!resQR)
                        return;
                    if (resQR && resQR.list) {
                ...
                model.com.getDeviceItemResult({ TaskID: 0, TaskType: 0, Resource: 1, StartTime: "2000-04-26 19:15:19", EndTime: "4029-05-5 10:15:19" }, function (resResult) {
                    if (!resResult)
                        return;
