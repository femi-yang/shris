  ...
  //	    '<td style="min-width: 50px" data-title="PartsRatioList" data-value="{{PartsRatioList}}">{{PartsRatioList}}</td>',
    ...
    model = $com.Model.create({
        ...
        run: function () {
            ...
            DJTyperule = [];
            model.com.getDevicePointCheckType({ ModelID: -1, Name: "", Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", ConfigType: 1, BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1 }, function (res1) {
        ...
        com: {
            refresh: function () {
                model.com.getDevicePointCheckRule({ ModelID: -1, Name: "", TypeID: 0, DSType: 1, Active: -1, BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (resRule) {
                    if (!resRule)
                        return;
