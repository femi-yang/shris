    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-add-Device-DSH", "click", function () {
                $("body").append($com.modal.show(DEFAULT_VALUE_Device_Apply, KEYWORD_Device_Apply, "新增", function (rst) {
                    ...
                    if (rst.MaintainItemOptionsCustom.length > 0) {
                        for (var  i = 0; i < DateMItem.length; i++) {
            ...
            $("body").delegate("#zace-Device-task", "click", function () {
                var vdata = { 'header': '设备保养任务', 'href': './device_manage/deviceMaintain-task.html', 'id': 'DeviceMaintain-task', 'src': './static/images/menu/deviceManage/deviceMaintainLog.png' };
                window.parent.iframeHeaderSet(vdata);
            })
        ...
        run: function () {
            ...
            model.com.getDeviceMaintainType({ ModelID: -1, Name: "", DSType: 1, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res2) {
                    DateMType = res2.list;
            ...
            model.com.getDeviceMaintainItem({ ModelID: -1, Name: "", DSType: 1, Active: -1, StartTime: "2019-04-26 19:15:19", EndTime: "2029-05-5 10:15:19", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res1) {
                    DateMItem = res1.list;
                    $.each(res1.list, function (i, item) {
        ...
        com: {
            refresh: function () {
                model.com.getDeviceMaintainApply({ ModelID: -1, Name: "", TypeID: 0, DSType: 1, Status: 0, LedgerID: 0, ApplicantID: 0, ApproverID: 0, ConfirmID: 0, OAGetType: 0, StartTime: "2000-04-26 19:15:19", EndTime: "5029-05-5 10:15:19" }, function (resApply) {
                    if (!resApply)
                        return;
                ...
                //model.com.getDeviceMaintainApply({ ModelID: -1, Name: "", TypeID: 0, DSType: 1, Status: 0, LedgerID: 0, ApplicantID: 0, ApproverID: 0, ConfirmID: 0, OAGetType: 0, StartTime: "2000-04-26 19:15:19", EndTime: "5029-05-5 10:15:19" }, function (resQR) {
                //    if (!resQR)
                //        return;
                //    if (resQR && resQR.list) {
