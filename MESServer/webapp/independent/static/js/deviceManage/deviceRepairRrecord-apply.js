...
//       "DSType|DSType",
    ...
    model = $com.Model.create({
        ...
        run: function () {
            ...
            model.com.getDeviceRepairType({ ModelID: -1, Name: "", DSType: 1, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1 }, function (res2) {
                DateMType = res2.list;
            ...
            model.com.getDeviceRepairItem({ ModelID: -1, Name: "", DSType: 1, Active: -1, StartTime: "2019-04-26 19:15:19", EndTime: "2029-05-5 10:15:19", BusinessUnitID: -1, BaseID: -1, FactoryID: -1, WorkShopID: -1, LineID: -1 }, function (res1) {
                DateMItem = res1.list;
                $.each(res1.list, function (i, item) {
