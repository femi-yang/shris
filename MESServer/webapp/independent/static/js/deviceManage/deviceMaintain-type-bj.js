    ...
    model = $com.Model.create({
        ...
        events: function () {
            ...
            $("body").delegate("#zace-add-Device-Type", "click", function () {
                ...
                $("body").append($com.modal.show(DEFAULT_VALUE_Device_Type, KEYWORD_Device_Type, "新增", function (rst) {
                    ...
                    for (var i = 0; i < BJBYType.length; i++) {
                        if (BJBYType[i].Name == rst.Name && BJBYType[i].ModelID == Number(rst.ModelID)) {
                            alert("保养模板重复！");
                            return false;
                        }
                    }
            ...
            $("body").delegate("#zace-edit-Device-Type", "click", function () {
                ...
                $("body").append($com.modal.show(default_valueThree, KEYWORD_Device_Type, "修改", function (rst) {
                    ...
                    var _list = [];
                    for (var i = 0; i < BJBYType.length; i++) {
                        if (SelectData[0].ID != BJBYType[i].ID) {
                            _list.push(BJBYType[i]);
                        }
                    }
            ...
            $("body").delegate("#zace-active-Device-Type", "click", function () {
                ...
                for (var j = 0; j < BJBYType.length; j++) {
                    if (BJBYType[j].ModelID == Number(SelectData[0].ModelID)) {
                        if (BJBYType[j].Active == 1) {
            ...
            $("body").delegate("#zace-type-search-Type", "click", function () {
                var _vdata = { 'header': '备件保养项目', 'href': './device_manage/deviceMaintain-item-bj.html', 'id': 'DeviceMaintenance-item-bj', 'src': './static/images/menu/deviceManage/sparePartItem.png' };
        ...
        run: function () {
            ...
            model.com.getDeviceMaintainItem({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-26 19:15:19", EndTime: "2029-05-5 10:15:19", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res1) {
                ...
                model.com.getSpareModel({ SpareWorkType: 0, SupplierID: 0, ModelPropertyID: 0, Active: -1, SupplierModelNo: "", StartTime: "2019-02-10 15:38:29", EndTime: "2029-05-10 15:38:29" }, function (res2) {
        ...
        com: {
            refresh: function () {
                model.com.getDeviceMaintainType({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-10 15:38:29", EndTime: "2029-05-10 15:38:29", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (resType) {
                    if (!resType)
                        return;
                ...
                window.parent.BJBY_Type = 1;
            },
            setItem: function () {
                setTimeout(function () {
                    if (window.parent.BJBY_Item == 1) {
                        model.com.getDeviceMaintainItem({ ModelID: -1, Name: "", DSType: 2, Active: -1, StartTime: "2019-04-26 19:15:19", EndTime: "2029-05-5 10:15:19", BusinessUnitID: 0, BaseID: 0, FactoryID: 0, WorkShopID: 0, LineID: 0 }, function (res1) {
