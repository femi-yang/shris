...
define([ "../jquery-3.1.1", "./bootstrap" ], function($yang, Bs) {
	+function(a, b) {
		...
		j.prototype = {
			...
			update : function() {
				...
				return arguments.length ? (a.each(arguments, a.proxy(function(a, b) {
					...
					}, this)), d = !0) : (c = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val(), c = c && this.o.multidate ? c.split(this.o.multidateSeparator) : [ c ],
					delete this.element.data().date
				...
				if (1 === g.length) switch (g[0].nodeName.toLowerCase()) {
					case "th":
						...
						case "next":
							...
							break;case "today":
							var i = new Date;
							i = c(i.getFullYear(), i.getMonth(), i.getDate(), 0, 0, 0), this.showMode(-2);var j = "linked" === this.o.todayBtn ? null : "view";
							this._setDate(i, j);
							break;case "clear":
							this.clearDates()
						}
		...
		var k = function(b, c) {
			...
			delete c.inputs
			, m.call(a(this.inputs), c).bind("changeDate", a.proxy(this.dateUpdated, this)), this.pickers = a.map(this.inputs, function(b) {
